                ...
                <div className="container">
                    <div className="" data-aos="fade-up">
                        ...
                        <div className="text-center" style={{ display: 'flex' }}>
                            <div >
                                <span className="px-3 arrowIcon" ><IconChevronsLeft style={{ color: "black"}} onClick={handleLeftClick} className="leftarrow" /></span>
                            </div>
                            ...
                            <div>
                                <span className="px-3 arrowIcon"><IconChevronsRight style={{ color: "black"}} onClick={handleRightClick} className="rightarrow" /></span>
                            </div>
                        </div>
                    </div>
                </div>
