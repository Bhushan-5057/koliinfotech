    ...
    <Fragment>
      ...
      <section className="pt-28 pb-16 bg-slate-50 min-h-screen">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose-policy space-y-6 text-slate-600 leading-relaxed">
            <p>
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-3">Data Protection</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-8 mb-3">Third-Party Services</h2>
            <p>
